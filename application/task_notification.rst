...
从前文我们知道，任务通知是任务控制块的资源，那它也算任务控制块中的成员变量，包含在任务控制块中，我们将其拿出来看看，具体见 代码清单:通知-1_ 加粗部分。
...
xTaskNotifyFromISR()的使用很简单的，具体见 代码清单:通知-10_ 加粗部分。
...
信号量，任务同步成功则继续执行，然后在串口调试助手里将运行信息打印出来，具体见 代码清单:通知-19_ 加粗部分。
